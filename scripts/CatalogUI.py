# Form implementation generated from reading ui file 'CatalogWindow.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(30, 90, 681, 431))
        font = QtGui.QFont()
        ...
        self.backbtn.setGeometry(QtCore.QRect(20, 530, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.backbtn.setFont(font)
        self.backbtn.setObjectName("backbtn")
        self.sortby = QtWidgets.QComboBox(parent=Form)
        self.sortby.setGeometry(QtCore.QRect(180, 20, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.sort.setGeometry(QtCore.QRect(360, 20, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.sort.setFont(font)
        self.sort.setObjectName("sort")
        self.label_2 = QtWidgets.QLabel(parent=Form)
        self.label_2.setGeometry(QtCore.QRect(760, 80, 101, 81))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.name_query.setGeometry(QtCore.QRect(730, 150, 141, 21))
        self.name_query.setObjectName("name_query")
        self.search = QtWidgets.QPushButton(parent=Form)
        self.search.setGeometry(QtCore.QRect(760, 180, 93, 28))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.search.setFont(font)
        self.search.setObjectName("search")
        self.statusbar = QtWidgets.QLabel(parent=Form)
        self.statusbar.setGeometry(QtCore.QRect(760, 290, 81, 71))
    ...
    def retranslateUi(self, Form):
        ...
        self.sortby.setItemText(0, _translate("Form", "Популярность"))
        self.sortby.setItemText(1, _translate("Form", "Название"))
        self.sortby.setItemText(2, _translate("Form", "Дата создания"))
        self.label.setText(_translate("Form", "Сортировать по:"))
        self.sort.setText(_translate("Form", "Отсортировать"))
        self.label_2.setText(_translate("Form", "Поиск по названию:"))
